  ...
  <footer class="footer" role="contentinfo">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <p class="mb-1">&copy; Copyright <strong><?php echo $app->app_name ?>.</strong> | <?php echo date('Y');?> | All Rights Reserved.</p>
          <div class="credits">
            <!-- Designed by <a href="https://simpelinaja.com/" target="_blank">Simpelin Aja</a> -->
          </div>
        </div>
